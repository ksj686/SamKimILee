...
09. <a href=#9>Troubleshooting</a><br>
10. <a href=#10>AI 자동화 시스템</a><br>
11. <a href=#11>상세페이지 구현</a><br>
...
- Bootstrap, Chart.js, DataTables 라이브러리를 활용해 필요한 데이터베이스 정보를 보다 직관적으로 시각화하고, 주요 데이터를 한눈에 파악할 수 있도록 구현하였습니다.
...
- Git 관리 과정에서 협업 중 발생한 충돌 상황을 직접 해결하며 merge conflict 처리에 익숙해졌고, 브랜치 전략에 대한 실습을 통해 merge, rebase 의 개념을 실제 상황에 적용해볼 수 있었습니다.
- Notion을 활용해 프로젝트 일정, 역할 분담표, 기능 구현 체크리스트를 작성하고 공유하였습니다. 각 기능별 우선순위와 담당자를 명확히 표시하고, 완료 여부를 실시간으로 업데이트할 수 있도록 구성해 팀원 간 진행 상황을 쉽게 파악할 수 있었습니다. 이를 통해 중복 작업이나 일정 지연 없이 원활한 협업이 가능했습니다.
- 윈도우 서버의 작업 스케줄러와 리눅스 서버에서 사용하던 cron 기능은 이미 알고 있었지만, 이번 프로젝트에서는 스프링 스케줄러를 새롭게 배울 수 있었습니다. 이를 통해 스케줄링 작업을 보다 쉽게 구현하고, 효율적으로 관리할 수 있었습니다.
